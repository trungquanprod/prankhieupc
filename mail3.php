...
?>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        <h4 class="header-title mt-0"><i class="fa fa-thumbs-up"></i> <?php echo $loai4 ;?></h4>
                        <br>
                        <form action="" id="" data-price="" method="" accept-charset="utf-8">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  value="<?php $hotmail4 = mysqli_num_rows(mysqli_query($ketnoi,"SELECT `id` FROM `hotmail` WHERE `loai` = '4' "));  echo $hotmail4; ?> Mail" >
                            </div>
 ...
 <option value="4"> <b><?php echo $loai4; ?> | <?php echo $gia4; ?>  VNĐ|Còn <?php $hotmail4 = mysqli_num_rows(mysqli_query($ketnoi,"SELECT `id` FROM `hotmail` WHERE `loai` = '4' "));  echo $hotmail4;?> Cái</option>                                </select>
                            </div>
                            ...
                            <div class="box-price">
                                <div class="price-content"><b id="tongthanhtoan" class="price-text"> VND</b>
                                    <br><span class="price-over-text">Giá <?php echo $loai4 ;?> <span class="quantity"></span><span class="type"></span> với giá mỗi <span class="type"></span>cái là <span class="price"></span> <?php echo $productions4 ;?> VND / 1  </span>
                                </div>
                            </div>
                            <center>
